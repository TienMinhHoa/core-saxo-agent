"""Gradio composition for the legacy music-material UI."""
...
from music_rag.ui_assets import chroma_asset_paths
from music_rag.ui_rendering import format_answer_cost, render_chroma_results
