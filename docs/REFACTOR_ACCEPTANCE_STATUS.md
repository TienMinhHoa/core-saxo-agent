...
- Bằng chứng offline hiện tại: `uv run pytest` đạt **327 passed, 2 skipped, 1 warning**;
...
| 13 | Unit/contract/integration/API/golden offline | Đạt offline | `uv run pytest`: 327 passed, 2 skipped, 1 warning |
